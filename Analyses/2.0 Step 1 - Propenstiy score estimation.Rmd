...
kbl(as.data.frame(balance_pre12$sum.all)[-1,1:4], digits = 2, format = "latex", col.names = c("Mean Treated", "Mean Control", "SMD/Cohen's d", "VR"), caption = "Balance check on all data before matching age 12", booktabs = T, label = "balance_pre") 
...
```{r Table on all datasets (horizontal)}
...
```{r Table on all datasets (vertical)}
...
plot11 <- ggplot() + 
  ...
  ggtitle("Propensity score distribution group 11") +
  theme(plot.title = element_text(hjust = 0.5)) +
  annotate(geom = "label", x = 0, y = 50, label = "Treat", 
           fill = "#611d08", color = "white", hjust = 0) +
  annotate(geom = "label", x = 0, y = -50, label = "Control", 
           fill = "#084c61", color = "white", hjust = 0) +
...
plot12 <- ggplot() + 
  ...
  geom_histogram(data = filter(prop_scores_by_group12, group12 == 0), 
                 ...
                 fill = "#084c61") +
  geom_hline(yintercept = 0) +
  ggtitle("Propensity score distribution group 12") +
  theme(plot.title = element_text(hjust = 0.5)) +
  annotate(geom = "label", x = 0, y = 50, label = "Treat", 
           fill = "#611d08", color = "white", hjust = 0) +
  annotate(geom = "label", x = 0, y = -50, label = "Control", 
...
plot14 <- ggplot() + 
  ...
  geom_histogram(data = filter(prop_scores_by_group14, group14 == 0), 
                 ...
                 fill = "#084c61") +
  geom_hline(yintercept = 0) +
  ggtitle("Propensity score distribution group 14") +
  theme(plot.title = element_text(hjust = 0.5)) +
  annotate(geom = "label", x = 0, y = 50, label = "Treat", 
           fill = "#611d08", color = "white", hjust = 0) +
  annotate(geom = "label", x = 0, y = -50, label = "Control", 
...
plot15 <- ggplot() + 
  ...
  geom_histogram(data = filter(prop_scores_by_group15, group15 == 0), 
                 ...
                 fill = "#084c61") +
  geom_hline(yintercept = 0) +
  ggtitle("Propensity score distribution group 15") +
  theme(plot.title = element_text(hjust = 0.5)) +
  annotate(geom = "label", x = 0, y = 50, label = "Treat", 
           fill = "#611d08", color = "white", hjust = 0) +
  annotate(geom = "label", x = 0, y = -50, label = "Control", 
