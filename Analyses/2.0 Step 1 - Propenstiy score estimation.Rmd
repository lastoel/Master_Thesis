...
kbl(as.data.frame(balance_pre12$sum.all)[-1,1:4], digits = 2, format = "latex", col.names = c("Mean Treated", "Mean Control", "SMD/Cohen's d", "VR"), caption = "Balance check on all data before matching age 12", booktabs = T, label = "balance_pre_12") 
