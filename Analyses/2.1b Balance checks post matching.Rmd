...
barplot(height = classdist_12t$n[classdist$n > 2], names.arg = classdist_12$subclass[classdist_12$n > 2])

length(classdist_12st$n[classdist_12lassdist$n > 2]) #368 subclasses with more than 2 matches
length(classdist_12t$n[classdist_12ist$n > 3]) #317 with more than 
