...
comptime_fullmatch_p11_100 <- end_time - start_time  
obj.size_fullmatch_p11_100 <- object.size(fullmatches_p11_100) 

#create dataset age =< 11
fullmatchdat_p11_100 <- lapply(fullmatches_p11_100, function(x) {match.data(x, group = "all", distance = "prop.score", data = step1_dat, drop.unmatched = T)})

#save dataset age =< 11
save(fullmatchdat_p11_100, file = "Analyses/Workspaces/fullmatchdat_p11_100.Rdata")
