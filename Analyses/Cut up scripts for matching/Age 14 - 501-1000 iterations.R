...
comptime_fullmatch_p14_1000 <- end_time - start_time  
obj.size_fullmatch_p14_1000 <- object.size(fullmatches_p14_1000)

#create dataset age =< 14
fullmatchdat_p14_1000 <- lapply(fullmatches_p14_1000, function(x) {match.data(x, group = "all", distance = "prop.score", data = step1_dat, drop.unmatched = T)})

#save dataset age =< 14
save(fullmatchdat_p14_1000, file = "Workspaces/fullmatchdat_p14_1000.Rdata")
