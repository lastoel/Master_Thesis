...
comptime_fullmatch_p14_500 <- end_time - start_time  
obj.size_fullmatch_p14_500 <- object.size(fullmatches_p14_500)

#create dataset age =< 14
fullmatchdat_p14_500 <- lapply(fullmatches_p14_500, function(x) {match.data(x, group = "all", distance = "prop.score", data = step1_dat, drop.unmatched = T)})

#save dataset age =< 14
save(fullmatchdat_p14_500, file = "Workspaces/fullmatchdat_p14_500.Rdata")
