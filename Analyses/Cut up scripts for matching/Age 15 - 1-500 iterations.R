...
comptime_fullmatch_p15_500 <- end_time - start_time  
obj.size_fullmatch_p15_500 <- object.size(fullmatches_p15_500)

#create dataset age =< 15
fullmatchdat_p15_500 <- lapply(fullmatches_p15_500, function(x) {match.data(x, group = "all", distance = "prop.score", data = step1_dat, drop.unmatched = T)})

#save dataset age =< 15
save(fullmatchdat_p15_500, file = "Workspaces/fullmatchdat_p15_500.Rdata")
