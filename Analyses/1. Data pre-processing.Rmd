...
kable(table(step1_dat$selection_age), 
      format = "latex", 
      caption = "Frequencies of age at first selection in OECD countries")
```

```{r Latex table selection age + groups}
kable(sel_age %>% filter(OECD_status == 1) %>% 
      ...
      format = "latex", 
      col.names = c("Country", "Age at first selection", "Grouping by age 11", "Grouping by age 12", "Grouping by age 14", "Grouping by age 15"), 
...
kable(sel_age %>% filter(OECD_status == 1) %>% 
        dplyr::select(Country, selection_age),
      format = "latex", 
      col.names = c("Country", "Age at first selection"), 
      caption = "Age at first selection of each OECD country")
```
